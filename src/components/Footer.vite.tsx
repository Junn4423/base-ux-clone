...
const footerLinks = {
  ...
  sanpham: {
    ...
    links: [
      { label: "Phần mềm ERP", href: "http://sof.com.vn/vi/Phan-mem/18/Phan-mem-quan-tri-nguon-luc-doanh-nghiep-(ERP--SOF).html" },
      { label: "Phần mềm HRM", href: "http://sof.com.vn/vi/Phan-mem/1/Phan-mem-nhan-su-tien-luong.html" },
  ...
  fnb: {
    title: "F&B - Bán lẻ",
    links: [
      { label: "Quản lý quán cafe", href: "http://sof.com.vn/vi/Phan-mem/75/Phan-mem-quan-ly-quan-cafe.html" },
      { label: "Quản lý nhà hàng", href: "http://sof.com.vn/vi/Phan-mem/76/Phan-mem-quan-ly-nha-hang.html" },
      { label: "Quản lý bán hàng", href: "http://sof.com.vn/vi/Phan-mem/23/Phan-mem-quan-ly-ban-hang.html" },
    ],
  },
  dichvu: {
    title: "Dịch vụ & Vận tải",
    links: [
      { label: "Quản lý khách sạn", href: "http://sof.com.vn/vi/Phan-mem/77/Phan-mem-quan-ly-khach-san.html" },
      { label: "Quản lý vận tải", href: "http://sof.com.vn/vi/Phan-mem/78/Phan-mem-quan-ly-van-tai.html" },
      { label: "Quản lý kho pallet", href: "http://sof.com.vn/vi/Phan-mem/374/Phan-men-quan-ly-kho-pallet.html" },
    ],
  },
  hotro: {
        ...
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-[#a7d5ec]">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 sm:gap-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
              <a href="/" className="flex items-center gap-2 sm:gap-3" aria-label="Trang chủ SOF.COM.VN">
                <img
                  src={sofLogo}
                  alt="Logo SOF.COM.VN"
                  ...
                  decoding="async"
                />
                <span className="text-[#0f426c] font-bold text-lg sm:text-xl">SOF.COM.VN</span>
              </a>
